...
window.GH_PETS = {
  ...
  pets: [
    ...
    { id:'p13', tier:'legendary', name:'Mimi the Baby Unicorn', slug:'mimi-the-baby-unicorn',
      ...
      cost:9000, need:{ now:30, run:90, allPets:true, allSlots:true }, about:{ en:'Mimi looks sweet and sparkly, but that little horn comes with opinions. She likes a touch of magic, a good result, and just enough sarcasm to keep things interesting.',
    ...
    { id:'p14', tier:'legendary', name:'Daisy the Lucky Dragon', slug:'daisy-the-lucky-dragon',
      ...
      cost:9000, need:{ now:30, run:90, mature:150 }, about:{ en:'Daisy is a cheerful little dragon who carries good luck wherever she goes. She loves sparkles, shiny days, and saving a little extra luck for when you need it.',
    ...
    { id:'p15', tier:'legendary', name:'Noir the Black Panther Ninja', slug:'noir-the-black-panther-ninja',
      ...
      cost:9000, need:{ now:30, run:90, grown:6, awards:12 }, about:{ en:'Quiet, watchful, and most at home in the shadows. Noir notices everything, says little, and somehow makes even a compliment sound like a warning.',
    ...
    { id:'p16', tier:'legendary', name:'Ember the Baby Phoenix', slug:'ember-the-baby-phoenix',
      ...
      cost:15000, need:{ now:30, run:150, legendaries:3 }, about:{ en:'Ember may be tiny, but she has enough fire for a grand performance. If something goes wrong, she shakes off the ashes, rises again, and gets ready for the encore.',
